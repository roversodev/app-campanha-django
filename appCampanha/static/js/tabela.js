const search = document.querySelector('.input-group2 input'),
...
const toPDF = function (customers_table) {
    ...
    <main id="customers_table">${customers_table.innerHTML}</main>`;
...
const parentElement = document.querySelector('.export__file');
